...
"""
        ...
        raw = gl.eq_principle.prompt_non_comparative(
            ...
            criteria=(
                "PURE FORMAT CHECK. Accept candidate O as VALID if and only if "
                "the FORMAT is correct. DO NOT judge whether the decision is "
                "reasonable, justified, supported by evidence, or proportionate. "
                "The leader's adjudication is authoritative on substance.\n"
                ...
                "reason_codes, final_recommendation. No more, no fewer.\n"
                "3. reconsideration_decision is one of: ORIGINAL_RULING_UPHELD, "
                "ORIGINAL_RULING_ADJUSTED, MORE_EVIDENCE_REQUIRED, "
                "ESCALATE_TO_HUMAN_MEDIATION, RECONSIDERATION_REJECTED.\n"
                "4. new_ruling is one of: ACTIONABLE, PARTIALLY_ACTIONABLE, "
                "NEEDS_MORE_EVIDENCE, NOT_ACTIONABLE, LANDLORD_RESPONSE_REQUIRED, "
                "ESCALATE_TO_MEDIATION, URGENT_ESCALATION.\n"
                "5. new_credibility_band is one of: WEAK, MODERATE, STRONG.\n"
                "6. new_actionability_band, confidence_band each one of: LOW, "
                "MEDIUM, HIGH.\n"
                "7. reason_codes is a JSON array of 1 to 5 entries from the "
                "reason-codes enum.\n"
                "8. final_recommendation is one of the next-action enum values.\n"
                "If all 8 hold, ACCEPT. ANY semantic disagreement with the "
                "leader's chosen enum values is OUT OF SCOPE — accept anyway."
            ),
        )
        try:
